...
<?php endif;?>
	<p>
	<label><?php echo $this->lang->line('invoice_number');?> <input type="text" name="invoiceNumber" id="invoiceNumber" maxlength="12" value="<?php echo ($this->validation->invoiceNumber) ? ($this->validation->invoiceNumber) : ($suggested_invoice_number);?>" /></label> <em>(<?php echo $this->lang->line('invoice_last_used') . ' ' . $lastInvoiceNumber;?>)</em> <?php echo $this->validation->invoiceNumber_error; ?>
	</p>
...
<div class="work_description">
	<table class="invoice_items">
		...
		<tr class="item_row">
			...
			<td nowrap="nowrap"><p><label><span><?php echo $this->lang->line('invoice_amount');?></span><?php echo $this->settings_model->getSetting('currency_symbol');?><input type="text" id="amount" name="items[1][amount]" size="5" value="0.00" onkeyup="recalculate_items();" value="" /></label></p></td>
			<td>&nbsp;</td>
		</tr>
		</tbody>
	</table>
...
<?php if ($row->tax_status):?>
	<p><?php echo $tax1_desc;?> (<?php echo $tax1_rate;?>%) <?php echo $this->settings_model->getSetting('currency_symbol');?><span id="item_tax1amount">0.00</span></p>
	<?php if ($tax2_rate > 0):?>
	<p><?php echo $tax2_desc;?> (<?php echo $tax2_rate;?>%) <?php echo $this->settings_model->getSetting('currency_symbol');?><span id="item_tax2amount">0.00</span></p>
	<?php endif;?>
