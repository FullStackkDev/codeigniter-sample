...
<?php echo form_open('clientcontacts/edit', array('id' => 'clientcontact'));?>
...
<p><input type="submit" name="createClient" id="createClient" value="<?php echo $this->lang->line('clients_edit_client');?>" /></p>
</form>
