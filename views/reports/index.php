...
?>]<?php
if (max($month_tax1) != 0) {
	echo ",\n'" . $this->settings_model->getSetting('tax1_desc') . "': 	[";
...
if (max($month_tax2) != 0) {
	echo ",\n'" . $this->settings_model->getSetting('tax2_desc') . "': 	[";
...
<p><?php echo $this->lang->line('invoice_there_are_currently');?> <?php echo $overdueInvoicesCount;?> <?php echo $this->lang->line('invoice_overdue_invoices');?><?php if ($overdueInvoicesCount > 0):?>.  <?php echo $this->lang->line('invoice_total');?> <?php echo $this->settings_model->getSetting('currency_symbol');?><?php echo $overdueInvoicesAmount;?><?php endif; ?></p>

<h3><?php echo $this->lang->line('invoice_open');?></h3>
<p><?php echo $this->lang->line('invoice_there_are_currently');?> <?php echo $openInvoicesCount;?>. <?php if ($openInvoicesCount > 0):?><?php echo $this->lang->line('invoice_total');?>: <?php echo $this->settings_model->getSetting('currency_symbol');?><?php echo $openInvoicesAmount;?><?php endif; ?></p>
...
<li><?php echo $yearToDateTax1 . ' ' . $this->settings_model->getSetting('tax1_desc');?></li>
<?php endif; ?>
<?php if ($yearToDateTax2 != ''):?>
<li><?php echo $yearToDateTax2 . ' ' . $this->settings_model->getSetting('tax2_desc');?></li>
<?php endif; ?>
<?php endif; ?>
</ul>
