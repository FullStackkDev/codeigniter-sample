...
<?php echo form_open('clients/edit', array('id' => 'newClientForm', 'onsubmit' => 'return requiredFields();'));?>
...
<fieldset><legend><?php echo $this->lang->line('invoice_tax_status');?>:</legend>
...
<input type="submit" name="updateClient" id="updateClient" value="<?php echo $this->lang->line('clients_update_client');?>" /> 
</form>
