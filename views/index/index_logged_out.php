...
<div id="loginform">
    ...
    <p>If you are interested in seeing <?php echo $this->lang->line('bambooinvoice_logo');?>
    in action, please <?php echo anchor('login', 'login');?> with the username "info@bambooinvoice.org" and the password "demo"... </p>
</div>

<p><?php echo anchor('http://www.bambooinvoice.org', $this->lang->line('bambooinvoice_logo'), array('title'=>'BambooInvoice'));?> is free open-source invoicing software intended for small businesses and independent contractors.  Our number one priorities are ease of use, user-interface, and beautiful code.</p>

<p><?php echo $this->lang->line('bambooinvoice_logo');?> was built by  designer and programmer <a href="http://www.derekallard.com/">Derek Allard</a>, who uses it everyday, not by a large firm who can't remember the names of its customers.  It is meant to be sexy, both on top of, and under the hood.  Go ahead, kick the tires.  View source shows semantic, structured, meaningful <acronym title="Extensible Hypertext Markup Language">XHTML</acronym>.  We use <acronym title="Asynchronous Javascript And XML">AJAX</acronym> to keep things peppy and javascript to keep things functional.  The entire application degrades gracefully for users without javascript enabled, and complies with <acronym title="Web Accessibility Initiative">WAI</acronym> priority two.</p>

<div class="work_description download">
	<p><a id="bamboodownload" href="http://www.bambooinvoice.org/img/bambooinvoice_083.zip">Download Bamboo 0.8.3</a> <strong>December 12 ,  2007</strong> (view <?php echo anchor ('changelog', 'changelog') . ' and ' . anchor('credits', 'credits');?>) </p>
</div>
...
<ul>
	...
	<li><?php echo $this->lang->line('bambooinvoice_logo');?> is built atop modern coding standards.  Its a <acronym title="Extensible Hypertext Markup Language">XHTML</acronym>-strict, <acronym title="Web Accessibility Initiative">WAI</acronym> conformant, <acronym title="Cascading Style Sheets">CSS</acronym> using treat!</li>
	<li><?php echo $this->lang->line('bambooinvoice_logo');?> is internationalized. Currently it is available in English, French, German, Dutch, Romanian, Spanish, Portuguese and Bulgarian, with new languages being added all the time. </li>
	<li>Built on the excellent <a href="http://www.codeigniter.com/">CodeIgniter</a> project.</li>
...
<h3>Requirements</h3>
<p><?php echo $this->lang->line('bambooinvoice_logo');?> is built using <acronym title="Hypertext Preprocessor">PHP</acronym> 5 and needs a database (Supported databases are MySQL, MySQLi, MS SQL, Postgre, SQLite, and ODBC). In order to generate PDFs, you'll need the DOM extension enabled. </p>
<?php
